...
public class CrudTestingOneToOne {
	...
	public void addNewEmployeeWithoutPassport() {
		Employee theEmp = new Employee();
		theEmp.setEmployeeName("Krish");
		theEmp.setEmployeeJob("devl");
		theEmp.setJoiningDate(LocalDate.of(2018, 6, 22));
	...
	public void assignExistingPassportToExistingEmployee() {
		...
		EntityTransaction tx = em.getTransaction();
		tx.begin();
			Passport passport = em.find(Passport.class, 12);
			Employee theEmp   = em.find(Employee.class, 11);
	...
	public void assignExistingPassportToNewEmployee() {
		...
		tx1.begin();
			...
			Passport passport = em.find(Passport.class, 15); //ATTACHED
			
			Employee theEmp = new Employee(); //TRANSIENT
			theEmp.setEmployeeName("JOSEPH");
			theEmp.setEmployeeJob("CLERK");
			theEmp.setJoiningDate(LocalDate.of(2015, 6, 22));
			theEmp.setSalary(72500);
			theEmp.setAge(33);
			theEmp.setPassport(passport);
	...
	public void assignNewPassportToExistingEmployee() {
		...
		tx.begin();
			...
			Employee theEmp   = em.find(Employee.class, 18);

			Passport passport = new Passport();
			passport.setIssuedBy("Govt. Of. china");
